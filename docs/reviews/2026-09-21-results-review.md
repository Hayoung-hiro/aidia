...
## Main integration (0.5.1)

Merged the UX changes with main's Stage 1 identification/replicate filtering
update. The merged full suite passed 1487 assertions with zero failures/errors
and four missing-fixture skips. A merged-app browser check confirmed the 0.5.1
footer, upload and optimization, download placement, identical single/ZIP Thermo
CSV, three ZIP formats, and all four comparison disclosures without UI errors.
