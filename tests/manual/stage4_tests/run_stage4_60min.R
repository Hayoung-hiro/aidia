# =============================================================================
# Run Stage 4 Visualization for 60min Gradient
# =============================================================================
# Generates all 24 plots for 60min gradient dataset
...
cat("╔════════════════════════════════════════════════════════════════╗\n")
cat("║        Stage 4 Visualization - 60min Gradient                 ║\n")
cat("╚════════════════════════════════════════════════════════════════╝\n\n")
...
output_dir <- "results_60min_visualization"
...
cat(sprintf("✅ PDF report: %s/optimization_report.pdf\n", output_dir))
